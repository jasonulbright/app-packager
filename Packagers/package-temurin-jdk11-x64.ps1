...
.SYNOPSIS
    Packages Eclipse Temurin JDK 11 (x64) MSI for ConfigMgr.
...
function Invoke-StageTemurinJDK11X64 {
    ...
    # ("Eclipse Temurin JDK with Hotspot 11.0.30+7 (x64)"). Construct a
...
try {
    ...
    Write-LogErrorRecord -ErrorRecord $_ -Context 'package-temurin-jdk11-x64'
