...
App: Citrix Workspace app for Windows (LTSR ARM64)
CMName: Citrix Workspace LTSR ARM64
...
.SYNOPSIS
    Packages Citrix Workspace app for Windows, LTSR (ARM64), for ConfigMgr.
...
.PARAMETER FileServerPath
    ...
    Content is staged under: <FileServerPath>\Applications\Citrix\Citrix Workspace LTSR ARM64\<Version>

.PARAMETER DownloadRoot
    Local root folder for staging downloaded installers.
    Each packager creates a subfolder under this path (e.g., <DownloadRoot>\CitrixWorkspaceLTSRARM64).
    Default: C:\temp\ap
...
$PackagerName     = "package-citrixworkspace-ltsr-arm64"
$Architecture     = "ARM64"
...
$InstallerFilter  = "CitrixWorkspace*_ARM64*.exe"
$InstallerExclude = @()
$CatalogDownload  = $false

$VendorFolder = "Citrix"
$AppFolder    = "Citrix Workspace LTSR ARM64"

$BaseDownloadRoot = Join-Path $DownloadRoot "CitrixWorkspaceLTSRARM64"
