...
.SYNOPSIS
    Packages M365 Project (x64) for ConfigMgr using the Office Deployment Tool.
...
.DESCRIPTION
    ...
    and creates a ConfigMgr Application.
...
function Invoke-StageM365Project {
    ...
    if ($isOnline) {
        ...
        $appName = "M365 Project (x64) ($($ch.Tag))"
    }
    else {
        ...
        $appName = "M365 Project - $version (x64) ($($ch.Tag))"
    }
...
try {
    ...
    Write-LogErrorRecord -ErrorRecord $_ -Context 'package-m365project-x64'
