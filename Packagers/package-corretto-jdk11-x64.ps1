...
.SYNOPSIS
    Packages Amazon Corretto JDK 11 (x64) MSI for ConfigMgr.
...
function Invoke-StageCorrettoJDK11X64 {
    ...
    # Amazon's MSI ProductName is "Amazon Corretto (x64)" for v11/17/21/25
    # (no version in it), which collides in ConfigMgr. Construct an AppName that
...
try {
    ...
    Write-LogErrorRecord -ErrorRecord $_ -Context 'package-corretto-jdk11-x64'
