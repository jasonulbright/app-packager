...
App: Citrix Workspace app for Windows (LTSR x64)
CMName: Citrix Workspace LTSR x64
...
.PARAMETER DownloadRoot
    ...
    Each packager creates a subfolder under this path (e.g., <DownloadRoot>\CitrixWorkspaceLTSRx64).
    Default: C:\temp\ap
...
$PackagerName     = "package-citrixworkspace-ltsr-x64"
$Architecture     = "x64"
...
$InstallerFilter  = "CitrixWorkspace*_x64*.exe"
$InstallerExclude = @()
...
$BaseDownloadRoot = Join-Path $DownloadRoot "CitrixWorkspaceLTSRx64"
