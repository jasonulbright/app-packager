...
function Invoke-StageM365Apps {
    ...
    if ($isOnline) {
        ...
        $appName = "M365 Apps for Enterprise (x64) ($($ch.Tag))"
    }
    else {
        ...
        $appName = "M365 Apps for Enterprise - $version (x64) ($($ch.Tag))"
    }
...
try {
    ...
    Write-LogErrorRecord -ErrorRecord $_ -Context 'package-m365apps-x64'
