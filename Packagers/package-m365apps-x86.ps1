...
.DESCRIPTION
    ...
    folder with file-based detection metadata, and creates a ConfigMgr Application.
...
function Invoke-StageM365Apps {
    ...
    if ($isOnline) {
        ...
        $appName = "M365 Apps for Enterprise (x86) ($($ch.Tag))"
    }
    else {
        ...
        $appName = "M365 Apps for Enterprise - $version (x86) ($($ch.Tag))"
    }
...
try {
    ...
    Write-LogErrorRecord -ErrorRecord $_ -Context 'package-m365apps-x86'
