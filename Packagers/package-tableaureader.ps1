...
.DESCRIPTION
    ...
    the newest TableauReader-64bit-<yyyy>-<m>-<p>.exe from a local folder
    instead.
...
.PARAMETER SourceFolder
    Folder that holds the Tableau Reader installer. When set, Stage uses the
...
# --- Configuration ---
$PackagerName       = "package-tableaureader"
$ProductLabel       = "Tableau Reader"
$InstallerFilter    = "TableauReader-64bit-*.exe"
$DisplayNamePattern = "Tableau Reader*"
$InstallSwitches    = @('/install', '/quiet', '/norestart', 'ACCEPTEULA=1', 'SENDTELEMETRY=0')
$UninstallSwitches  = @('/uninstall', '/quiet', '/norestart')
$RunningProcesses   = @('tabreader')
$ReleasePageUrl     = "https://www.tableau.com/support/releases"
# {0} is the hyphenated release (2026-2-2), {1} the dotted one (2026.2.2).
$DownloadUrlTemplate = "https://downloads.tableau.com/tssoftware/TableauReader-64bit-{0}.exe"
...
function Get-TableauVersionFromFileName {
    ...
    .SYNOPSIS
        ...
        TableauReader-64bit-2026-2-2.exe (2026.2.2).
    #>
